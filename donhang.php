...
<?php
	...
	unset($_SESSION["cart"]);
	$cart->destroy();
	echo "<span style='color:red;font-size:30px;'>Đặt hàng thành công!  </span>c"
	?>
   ...
   <div class="footer">
	     ...
	     <div class="section group">
				<div class="col_1_of_4 span_1_of_4">
						...
						<li><a href="#">Các chính sách Rei Shop</a></li>
			...
			<div class="copy_right">
				<p> ©  2020 - 2021 Rei Shop / Địa chỉ: bình Chánh, TP. Hồ Chí Minh.</p>
		   </div>
     </div>
    </div>
	  </div>
